...
insert into cash_account (name, date, email, cash_value) values ('Chequing','2021-01-01', 'j.d@citi.com', 1000);
insert into cash_account (name, date, email, cash_value) values ('Savings','2021-02-01', 'j.d@citi.com', 999);
